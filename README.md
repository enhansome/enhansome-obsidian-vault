...
[![Link Check](https://github.com/obsidian-pkm-vault/awesome-obsidian-vault/actions/workflows/links.yml/badge.svg)](https://github.com/obsidian-pkm-vault/awesome-obsidian-vault/actions/workflows/links.yml) ⭐ 517 | 🐛 3 | 📅 2026-08-27
...
* [Project N.O.M.A.D.](https://github.com/crosstalk-solutions/project-nomad) ⭐ 36,599 | 🐛 89 | 🌐 TypeScript | 📅 2026-09-09. Bundles Kiwix, a local AI assistant (Ollama + Qdrant), Kolibri courses, ProtoMaps, CyberChef, and FlatNotes.
* Wikipedia from itkach: [wiki](https://github.com/itkach/slob/wiki/Wikipedia) ⭐ 296 | 🐛 1 | 🌐 Python | 📅 2026-05-09
* Wikis and Dicts from itkach: [wiki](https://github.com/itkach/slob/wiki/Other-projects) ⭐ 296 | 🐛 1 | 🌐 Python | 📅 2026-05-09
...
* Wiktionary and Wikibooks from itkach: [wiki](https://github.com/itkach/slob/wiki/Wiktionary-and-Wikibooks) ⭐ 296 | 🐛 1 | 🌐 Python | 📅 2026-05-09
* Word Dictionaries (Wordnet and Freedict) from itkach: [wiki](https://github.com/itkach/slob/wiki/Word-dictionaries-\(Wordnet-and-Freedict\)) ⭐ 296 | 🐛 1 | 🌐 Python | 📅 2026-05-09

## Cheat Sheets and Miscellaneous (2)

* Anki Shared Decks: [vault](https://ankiweb.net/shared/decks/)
* Cheatsheets from rstacruz: [vault](https://github.com/rstacruz/cheatsheets) ⭐ 14,456 | 🐛 929 | 🌐 SCSS | 📅 2026-08-25

***

## List of Showcases (3)

* [Obsidian Digital Garden - Showcases](https://github.com/oleeskild/obsidian-digital-garden/issues/55) ⭐ 2,493 | 🐛 216 | 🌐 TypeScript | 📅 2026-09-08
* [Awesome list of Digital gardens - lyz-code](https://github.com/lyz-code/best-of-digital-gardens) ⭐ 591 | 🐛 2 | 🌐 Shell | 📅 2026-09-08
...
quickest way is to [open a "Suggest a vault" issue](https://github.com/obsidian-pkm-vault/awesome-obsidian-vault/issues/new/choose) ⭐ 517 | 🐛 3 | 📅 2026-08-27.
