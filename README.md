...
[![Link Check](https://github.com/obsidian-pkm-vault/awesome-obsidian-vault/actions/workflows/links.yml/badge.svg)](https://github.com/obsidian-pkm-vault/awesome-obsidian-vault/actions/workflows/links.yml) ⭐ 525 | 🐛 0 | 📅 2026-09-16
...
* [Project N.O.M.A.D.](https://github.com/crosstalk-solutions/project-nomad) ⭐ 37,990 | 🐛 96 | 🌐 TypeScript | 📅 2026-09-21. Bundles Kiwix, a local AI assistant (Ollama + Qdrant), Kolibri courses, ProtoMaps, CyberChef, and FlatNotes.
...
* Wiktionary and Wikibooks from itkach: [wiki](https://github.com/itkach/slob/wiki/Wiktionary-and-Wikibooks) ⭐ 300 | 🐛 1 | 🌐 Python | 📅 2026-05-09
* Word Dictionaries (Wordnet and Freedict) from itkach: [wiki](https://github.com/itkach/slob/wiki/Word-dictionaries-\(Wordnet-and-Freedict\)) ⭐ 300 | 🐛 1 | 🌐 Python | 📅 2026-05-09

## Cheat Sheets and Miscellaneous (2)

* Anki Shared Decks: [vault](https://ankiweb.net/shared/decks/)
* Cheatsheets from rstacruz: [vault](https://github.com/rstacruz/cheatsheets) ⭐ 14,461 | 🐛 931 | 🌐 SCSS | 📅 2026-08-25

***

## List of Showcases (3)

* [Obsidian Digital Garden - Showcases](https://github.com/oleeskild/obsidian-digital-garden/issues/55) ⭐ 2,504 | 🐛 217 | 🌐 TypeScript | 📅 2026-09-11
* [Awesome list of Digital gardens - lyz-code](https://github.com/lyz-code/best-of-digital-gardens) ⭐ 594 | 🐛 2 | 🌐 Shell | 📅 2026-09-21
...
quickest way is to [open a "Suggest a vault" issue](https://github.com/obsidian-pkm-vault/awesome-obsidian-vault/issues/new/choose) ⭐ 525 | 🐛 0 | 📅 2026-09-16.
